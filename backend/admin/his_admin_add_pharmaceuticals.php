...
<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['add_pharmaceutical']))
		{
			...
			$query="INSERT INTO his_pharmaceuticals (phar_name, phar_bcode, phar_desc, phar_qty, phar_cat, phar_vendor, phar_attribute, phar_unit, phar_price_unit) VALUES (?,?,?,?,?,?,?,?,?)";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('ssssssssi', $phar_name, $phar_bcode, $phar_desc, $phar_qty, $phar_cat, $phar_vendor, $phar_attribute, $phar_unit, $phar_price_unit);
			$stmt->execute();
			/*
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post">
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="inputPassword4" class="col-form-label">Pharmaceutical Quantity</label>
                                                    <input required="required" type="text" name="phar_qty" class="form-control"  id="inputPassword4">
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="form-group col-md-4">
                                                    <label for="inputEmail4" class="col-form-label">Pharmaceutical Attribute</label>
                                                    <input type="text" required="required" name="phar_attribute" class="form-control" id="inputEmail4" >
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="inputPassword4" class="col-form-label">Pharmaceutical Unit/Package</label>
                                                    <input required="required" type="text" name="phar_unit" class="form-control"  id="inputPassword4">
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="inputPassword4" class="col-form-label">Pharmaceutical Price/Unit</label>
                                                    <input required="required" type="text" name="phar_price_unit" class="form-control"  id="inputPassword4">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    ?>
                                                    <input type="text" value="<?php echo $phar_bcode;?>" name="phar_bcode" class="form-control"  id="inputPassword4">
                                            </div>

                                            <div class="form-group">
                                                <label for="inputAddress" class="col-form-label">Pharmaceutical Description</label>
                                                <textarea  type="text" class="form-control" name="phar_desc" id="editor"></textarea>
                                            </div>
