<?php
  ...
  $pat_number = $_SESSION['student_id'];
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <img src="assets/images/logo.png" alt="FUHSI Logo" style="height:80px;">
                                    <h1 class="mt-4">Welcome to FUHSI Clinic</h1>
                                    <p class="lead">Federal University Health Sciences, Ila-Orangun</p>
                                </div>
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="card shadow-sm mb-4">
                                        <div class="card-body">
                                        <h4 class="card-title">Please Kindly Follow these Steps Below</h4>
                                        <ol class="pl-3">
                                            <li class="mb-3">
                                            <strong>Register Your Profile</strong><br>
                                            Use the <em>“Create Profile”</em> To enter your personal details.
                                            </li>
                                            <li class="mb-3">
                                            <strong>Fill Screening Form</strong><br>
                                            Once your profile is set up, click the <em>“Medical Screening ”</em> To complete your health screening Form.
                                            <li>
                                            <strong> Submit &  Download</strong><br>
                                            After saving your screening form, use the Download PDF button at the bottom of that page to generate your copy for FUHSI Clinic.
                                            </li>
                                            <li>
                                            <strong> NOTE:</strong><br>
                                            Dont fill Clinic Official Part.
                                            </li>
                                        </ol>
                                        </div>
                                    </div>
                                    ...
                                    <div class="text-center text-muted small">
                                        Logged in as Student #<?php echo htmlspecialchars($pat_number); ?>
                                    </div>
