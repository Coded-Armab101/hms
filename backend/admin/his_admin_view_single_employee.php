...
if (isset($_GET['staff_id']) && isset($_GET['staff_number'])) {
    ...
    if (!$employee) {
        ...
        header("Location: his_admin_view_employees.php");
        exit();
    }
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-4 d-block d-lg-none">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <a href="his_admin_edit_employee.php?staff_id=<?php echo urlencode($staff_id); ?>&staff_number=<?php echo urlencode($staff_number); ?>" 
                                    ...
                                    <div class="mt-4 d-none d-lg-block">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <a href="his_admin_dashboard.php" class="btn btn-outline-primary btn-block">
