...
if (isset($_POST['add_lab_test'])) {
    ...
    $query = "INSERT INTO his_laboratory (pat_id,lab_pat_name, lab_pat_ailment, lab_date_rec, lab_pat_number, lab_pat_tests, lab_pat_results, lab_number) VALUES (?,?, ?, ?, ?, ?, ?, ?)";
    $stmt = $mysqli->prepare($query);
                        ...
                        <div class="col-lg-8 col-xl-8">
                            <div class="card-box">
                                ...
                                <ul class="nav nav-pills navtab-bg nav-justified">
                                    <li class="nav-item">
                                        <a href="#prescription" class="nav-link active" data-toggle="tab" aria-expanded="true">Prescription</a>
                                    </li>
                                   <!-- <li class="nav-item">
                                        <a href="#vitals" class="nav-link" data-toggle="tab" aria-expanded="false">Vitals</a>
                                    </li>
                                    <li class="nav-item">
                                                ...
                                                <form method="post">
                                                    <div class="form-row">
                                                       <div class="form-group col-md-3">
                                                            ...
                                                            <input type="number" step="0.1" class="form-control" name="vit_bodytemp" required disabled>
                                                        </div>
                                                        <div class="form-group col-md-3">
                                                            <label>Pulse Rate (bpm)</label>
                                                            <input type="number" class="form-control" name="vit_heartpulse" required disabled>
                                                        </div>
                                                        <div class="form-group col-md-6">
                                                            <label>Respiratory Rate (breaths/min)</label>
                                                            <input type="number" class="form-control" name="vit_resprate" required disabled>
                                                        </div>
                                                    </div>
                                                    <div class="form-row">
                                                        <div class="form-group col-md-4">
                                                            <label>Blood Pressure (mmHg)</label>
                                                            <input type="text" class="form-control" name="vit_bloodpress" required disabled>
                                                        </div>
                                                        <div class="form-group col-md-4">
                                                            <label>Weight (kg)</label>
                                                            <input type="number" step="0.1" class="form-control" name="vit_weight" required disabled>
                                                        </div>
                                                        <div class="form-group col-md-4">
                                                            <label>Height (m)</label>
                                                            <input type="number" step="0.01" class="form-control" name="vit_height" required disabled>
                                                        </div>
                                                    </div>    
                                                    <button type="submit" name="add_vitals" class="btn btn-primary" disabled>Save Vitals</button>
                                                </form>
                                            </div>-->
                                        </div>
                                        <hr>
