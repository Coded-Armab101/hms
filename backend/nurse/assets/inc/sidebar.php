                ...
                <div class="slimscroll-menu">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                <a href="his_nurse_dashboard.php">
                           ...
                           <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    ...
                                    <li>
                                        <a href="his_nurse_view_patients.php">View Patients</a>
                                    </li>
                                    <!--<li>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <!--<li>
                                        <a href="his_admin_book_appointment.php">Book Appointment</a>
                                    </li>-->
                                    <li>
                                        <a href="his_admin_view_appointments.php">View Appointment</a>
                                    </li>
                                </ul>
                            </li>
                           ...
                           <!-- <li>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    ...
                                    <li>
                                        <a href="his_nurse_view_payrolls.php">My Payrolls</a>
                                    </li>
                                </ul>
                            </li>
