...
?>
    <div class="navbar-custom">
            ...
            <li class="dropdown notification-list">
                <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect waves-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    ...
                    <span class="pro-user-name ml-1">
                        <?php echo $row->ns_fname;?> <?php echo $row->ns_lname;?> <i class="mdi mdi-chevron-down"></i> 
                    </span>
                </a>
                <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                    ...
                    <!-- item-->
                    <a href="his_nurse_logout_partial.php" class="dropdown-item notify-item">
        ...
        <!-- LOGO -->
        <div class="logo-box">
            <a href="his_nurse_dashboard.php" class="logo text-center">
                <span class="logo-lg">
        ...
        <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
            ...
            <li class="dropdown d-none d-lg-block">
                ...
                <div class="dropdown-menu">
                    ...
                    <!-- item-->
                    <a href="his_nurse_register_patient.php" class="dropdown-item">
                    ...
                    <!-- item-->
                    <a href="his_nurse_lab_report.php" class="dropdown-item">
