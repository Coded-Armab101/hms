                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <!--<li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li>
                                        <a href="his_lab_register_patient.php">Register Patient</a>
                                        </li>
                                        <li>
                                        <a href="his_lab_view_patients.php">View Patients</a>
                                    </li>
                                    <li>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    ...
                                    <li>
                                        <a href="his_lab_patient_lab_result.php">Patient Lab Results</a>
                                    </li>
                                    <!--<li>
                                    ...
                                    <li>
                                        <a href="his_lab_lab_report.php">Lab Reports</a>
                                    </li>
                                    <hr>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    ...
                                    <li>
                                        <a href="his_lab_pharm_inventory.php">Pharmaceuticals</a>
                                    </li>

                                    <li>
                                        <a href="his_lab_equipments_inventory.php">Assets</a>
                                    </li>
