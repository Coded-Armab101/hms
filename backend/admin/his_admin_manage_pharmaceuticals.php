                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="his_admin_update_single_pharm.php?phar_bcode=<?php echo $row->phar_bcode; ?>" class="badge badge-warning">
                                                        <i class="fas fa-clipboard-check"></i> Update
                                                    </a>
                                                    <a href="his_admin_manage_pharmaceuticals.php?delete_pharm_name=<?php echo $row->phar_id; ?>" class="badge badge-danger">
