<?php
    ...
    $ret="select * from his_record where rec_id=?";
...
?>
    <div class="navbar-custom">
        <ul class="list-unstyled topnav-menu float-right mb-0">
            ...
            <li class="dropdown notification-list">
                <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect waves-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    <img src="assets/images/users/<?php echo $row->rec_dpic;?>" alt="dpic" class="rounded-circle">
                    <span class="pro-user-name ml-1">
                        <?php echo $row->rec_fname;?> <?php echo $row->rec_lname;?> <i class="mdi mdi-chevron-down"></i> 
                    </span>
                </a>
                <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                    ...
                    <!-- item-->
                    <a href="his_record_logout_partial.php" class="dropdown-item notify-item">
        ...
        <!-- LOGO -->
        <div class="logo-box">
            <a href="his_record_dashboard.php" class="logo text-center">
                <span class="logo-lg">
        ...
        <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
            ...
            <li class="dropdown d-none d-lg-block">
                ...
                <div class="dropdown-menu">
                    <!-- item-->
                    <a href="his_record_employee_cat.php" class="dropdown-item">
                        <i class="fe-users mr-1"></i>
                        <span>Employee</span>
                    </a>

                    <!-- item-->
                    <a href="his_record_register_patient.php" class="dropdown-item">
