                                            ...
                                            */
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php $ident = trim((string)$row->pat_number) !== '' ? 'pat_number=' . rawurlencode($row->pat_number) : 'pat_id=' . intval($row->pat_id); ?>
                                                        <a href="his_admin_update_single_screening_form.php?<?= $ident ?>" class="badge badge-success"><i class="fas fa-file-signature"></i> Add </a>
                                                        <a href="his_admin_manage_single_screening_form.php?<?= $ident ?>" class="badge badge-warning"><i class="fas fa-file-signature"></i> Update </a>
                                                    </td>
