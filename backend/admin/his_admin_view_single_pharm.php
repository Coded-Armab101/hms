                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7">
                                                <div class="pl-xl-3 mt-3 mt-xl-0">
                                                    ...
                                                    <hr>
                                                    <h4 class="text-danger">Pharmaceutical Quantity : <?php echo $row->phar_qty;?></h4>
                                                    <hr>
                                                    <h4 class="text-danger">Pharmaceutical Attribute : <?php echo $row->phar_attribute;?></h4>
                                                    <hr>
                                                    <h4 class="text-danger">Unit/Package : <?php echo $row->phar_unit;?></h4>
                                                    <hr>
                                                    <h4 class="text-danger">Price/Unit : <?php echo $row->phar_price_unit;?></h4>
                                                    <hr>
<!--                                                    <h4 class="text-danger">Recorded by: <?php echo $row->phar_fname;?></h4> -->
                                                    <hr>
