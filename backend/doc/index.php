<?php
    ...
    if(isset($_POST['doc_login']))
    {
        ...
        $stmt=$mysqli->prepare("SELECT doc_number, doc_pwd, doc_id FROM his_docs WHERE  doc_email=? AND doc_pwd=? ");//sql to log in user
        ...
        $_SESSION['doc_email'] = $doc_email;//Assign session to doc_number id
                            ...
                            <div class="card-body p-4">
                                ...
                                <form method='post' >
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" name="doc_email" type="text" id="emailaddress" required="" placeholder="Enter your doctor number">
                                    </div>
